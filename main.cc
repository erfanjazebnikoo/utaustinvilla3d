...
void PrintGreeting() {
    cout << "Roxy 3D Simulation Team\n";

}

void PrintHelp() {
    cout << "\nusage: Roxy [options]" << endl;
    cout << "\noptions:" << endl;
...
=======
        cout << "Ramoooooooooooon 11111111" << endl;
    } else {
>>>>>>> Stashed changes
        throw "unknown agent type";
    }

    cout << "Ramoooooooooooon 22222222" << endl;
    
    PutMessage(behavior->Init() + "(syn)");
    
    cout << "Ramoooooooooooon 33333333" << endl;
